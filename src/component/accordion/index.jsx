...
export function Trigger({children, target, toggleAccordion, isOpen}){
	...
	return(
		<>
			<h2 id={target} onClick={(e) => toggleAccordion(e)} className={`z-[99] ${isOpen ? 'bg-indigo-100' : 'bg-white'}`}>
...
<>
	<div
		className={`transition-all  duration-300 h-full ${isOpen ? 'h-full' : 'h-0'} ${style}`} 
